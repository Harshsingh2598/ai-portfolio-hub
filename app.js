...
function initTheme(data) {
  if (data.theme) {
    ...
    // Custom glow variables if provided
...
function initChatbotUI(agent) {
  ...
  const cardPromptHint = document.querySelector(".card-prompt-hint");
  ...
  if (cardPromptHint) {
    cardPromptHint.addEventListener("click", () => {
      toggleDrawer(true);
      chatInput.value = "Show me your code RAG project";
...
// 9. Contact Form Validation & Simulated Submission
